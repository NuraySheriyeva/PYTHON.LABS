...
import os
#from snake_game import get_or_create_user, username

def run_game(save_callback=None, user_id=None):
    pygame.init()
    pygame.mixer.init()
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key==pygame.K_p:
                    paused= not paused 
                    if paused and save_callback:
                        save_callback(user_id, game_score, level)
